 ...
 */
  ...
  this.type = data.type;
  this.fromToDCName = data.dcLable;
  this.position = data.position;
  this.endPoint = data.endPoint;
  this.dcName = data.dcName;
  this.dcConnectedTo = data.dcConnectedTo;
...
ELabel.prototype.onAdd = function(map) {
  ...
  if(this.type === 'text'){
    ...
    div.innerHTML = '<div class="' + this.classname + '"><span class="glyphicon glyphicon-refresh spin"></span><span class="latencyValue">' + this.html + '</span></div>' ;
  }else{
    div.innerHTML = '<div class="' + this.classname + '">' + this.html + '</div>' ;
  }
...
ELabel.prototype.draw = function() {
  var proj = this.getProjection(), pos = proj.fromLatLngToDivPixel(this.point);
...
ELabel.prototype.setContents = function(html) {
  ...
  if(this.type === 'text'){
    ...
    this.div_.innerHTML = '<div class="' + this.classname + '"><span class="glyphicon glyphicon-refresh spin"></span><span class="latencyValue">' + this.html + '</span></div>' ;
  }else{
    this.div_.innerHTML = '<div class="' + this.classname + '">' + this.html + '</div>';
  }
